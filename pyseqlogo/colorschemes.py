...
cbb_palette_values = ["#000000", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7"]
cbb_palette_colors = ['black', 'orange', 'skyblue', 'green', 'yellow', 'blue', 'red', 'magenta']
...
default_colorschemes = {'basepairing' : basepairing,
                        'meme' : meme,
                        'classic' : classic,
