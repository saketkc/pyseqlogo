...
dna_naive_freq_table = FreqTable.FreqTable(dna_naive_freq,
                                           FreqTable.FREQ,
                                           IUPAC.unambiguous_dna)

rna_naive_freq_table = FreqTable.FreqTable(rna_naive_freq,
                                           FreqTable.FREQ,
                                           IUPAC.unambiguous_rna)

aa_naive_freq_table = FreqTable.FreqTable(aa_naive_freq,
                                           FreqTable.FREQ,
                                           IUPAC.protein)

naive_freq_tables = {'aa': aa_naive_freq_table,
